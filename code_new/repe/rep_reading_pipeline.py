...
class RepReadingPipeline(Pipeline):
    ...
    def get_directions(
        ...
        if direction_finder.needs_hiddens:
            ...
            #         # Even and odd positions store negative and positive contrastive examples. Hence, the num_samples gets reduced to half. 
            #         # relative_hidden_states of shape (num_layers, num_samples/2, hidden_dim)
        ...
        # for layer in direction_finder.directions.keys():
            # print(direction_finder.directions[layer].shape
